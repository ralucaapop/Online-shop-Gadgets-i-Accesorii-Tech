...
import {ListProductsComponent} from "../list_tastaturi/list-tastaturi";
...
@Component({
  ...
  templateUrl: './tastaturi.html',
  styleUrl: './taststuri.css'
})
export class TastaturiComponent implements OnInit {
